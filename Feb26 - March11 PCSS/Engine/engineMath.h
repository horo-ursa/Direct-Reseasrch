...
#pragma warning(pop)
    ...
    friend Vector3 Normalize(const Vector3& vec)
    {
        ...
        return Vector3(vec.x / vecLength, vec.y / vecLength, vec.z / vecLength);
    }
    ...
    bool isCloseEnuf(Vector3 b, float epsilon = 0.001f) {
       return Math::IsCloseEnuf(x, b.x) && Math::IsCloseEnuf(y, b.y) && Math::IsCloseEnuf(z, b.z);
    }
