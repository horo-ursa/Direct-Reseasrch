...
//"compiler directives", tells the linker to add the 'libname' library to the list of library dependencies
//similar to Linker->Input->Additional dependencies
//https://docs.microsoft.com/en-us/previous-versions/visualstudio/visual-studio-2013/7f0aews7(v=vs.120)?redirectedfrom=MSDN
